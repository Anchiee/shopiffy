...
function PopUp()
{
  ...
  return PopUpStatus ? (
      ...
      <AnimatedPage>
        <section className="inline bg-slate-200 text-base rounded-md py-8 px-10 mt-2 w-1/3 shadow-gray-300-500/50 shadow-lg absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <button className="mx-5 cursor-pointer" onClick={hidePopUp}>Close</button>

...
{ 
  ...
  let [popUpStatus, setPopUpStatus] = useState("invisible")
      ...
      <div className="bg-softBrown-200 py-14 w-1/3 px-8 rounded-md">
        ...
        <div className="flex flex-row items-center justify-between my-6">
          ...
          <div className="w-1/5 inline">
              ...
              py-2 w-full rounded-md transition-opacity hover:opacity-70" onClick={showPopup}>
                Edit
              </button>
          </div>
        </div>

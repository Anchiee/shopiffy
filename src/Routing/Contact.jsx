      ...
      <AnimatedPage>
        <section className="h-full flex justify-center items-center flex-row my-6.9">
          <div className="inline bg-slate-200 text-base rounded-md py-8 px-10 mt-2 w-1/3 shadow-gray-300-500/50 shadow-lg">
            ...
            className="block resize-none my-3 w-full rounded-md bg-transparent-100 px-3.5 py-2 text-base 
            text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 
